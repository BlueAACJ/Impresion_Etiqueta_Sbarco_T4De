...
# Imprime todos menos el último código de barras
for cod in codigos_barra[:-1]:
    epl += f'B30,{y_actual},0,1,3,3,80,N,"{cod}"\n'
    y_actual += 90
    epl += f'A100,{y_actual},0,3,1,1,N,"{cod}"\n'
    y_actual += 50

# Inserta el logo OGO1
epl += f'GG200,{y_actual},"OGO1"\n'
y_actual += 120
...
printer_name = "Sbarco T4De 203 dpi (PEPL)"
